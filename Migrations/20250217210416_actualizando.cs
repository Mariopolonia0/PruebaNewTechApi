        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotaTerminada = table.Column<string>(type: "TEXT", nullable: false),
                    FechaCreada = table.Column<string>(type: "TEXT", nullable: false),
                    FechaEmpezada = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Usuario",
                columns: new[] { "UsuarioId", "Apellido", "CodigoEmpresa", "Nombre", "NombreUsuario", "Password" },
                values: new object[] { 100, "admin", "SP", "Super", "admin", "admin" });
        }
